  ...
  function handleShare(event) {
    ...
    switch(platform) {
      ...
      case 'linkedin':
        ...
        break;
      case 'email':
        shareLink = `mailto:?subject=${encodeURIComponent('Check out this activity at Mergington High School')}&body=${encodeURIComponent(shareText + '\n\n' + shareUrl)}`;
        break;
      default:
        return;
    }
    ...
    if (platform === 'email') {
      ...
      window.open(shareLink, 'share-dialog', 'width=600,height=400');
    }
  }
